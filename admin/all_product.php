...
<body>
  ...
  <div class="container">
     <div><p style="text-align: right;"><a href="all_product.php?new=1" title="" class="btn btn-info"> Add New Product</a></p></div>
  		<?php 
  		...
  		<table class='table'>
  			...
  			<tr>
				...
				<td> <a href="all_product.php?edit= <?php echo $row["id"] ?>" title="" class="btn btn-info"> Edit</a></td>
