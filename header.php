       ...
       <div class="col-lg-8">
        <div class="serach1">
          <ul class="navbar-nav-search ">
            ...
            <li class=" cart"><picture>
                     ...
                     <a href="cart.php"> <img src="images/cart.png" class="" alt="icon"></a>
                    </picture>(<?php echo $count ?>)</li>
        ...
        <nav class="navbar navbar-expand-sm nav nav-a"> 
          ...
          <div class="collapse navbar-collapse navbar-collapse-a " id="navbarTogglerDemo02">
                    <ul class="navbar-nav ">
                        <li class="nav-item"><a class="nav-link-b text-center noHover" href="home.php">HOME</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link-b text-center noHover" href="all_product.php">PRODUCT</a></li>
                        <li class="nav-item"><a class="nav-link-b text-center noHover" href="all_category.php">CATEGORY</a></li>
                        <li class="nav-item"><a class="nav-link-b text-center noHover" href="#">ABOUT</a></li>
                        <li class="nav-item"><a class="nav-link-b text-center noHover" href="#"> HERB</a></li>
